...
*Displays the homepage with a dynamic carousel of trending movies with their trailers fetched from the TMDB API, styled with Tailwind CSS for a modern, responsive layout.*
